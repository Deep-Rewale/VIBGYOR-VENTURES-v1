        ...
        <section className='bg-page py-10 px-6 lg:px-16'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-5 '>
                {Images.map((item, index) => (
                    <div key={index} className={`${index === 0 || index === 3 ? "col-span-1 lg:col-span-2" : ""} `}>
