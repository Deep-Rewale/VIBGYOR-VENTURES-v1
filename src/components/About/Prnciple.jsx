...
const Prnciple = () => {
  return (
    <section className="bg-page py-10 px-6 lg:px-16">
      {/* full container */}
      <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-6 max-w-6xl mx-auto">
        {/* Left image */}
        <motion.div
          className="w-full"
        ...
        >
          <img
            loading="lazy"
            className="object-cover h-120 w-120  rounded-xl shadow-2xl max-lg:w-full"
            src={VisonImg}
            alt=""
          />
        </motion.div>
        ...
        >
          <p className="text-accent text-lg lg:text-xl font-body font-semibold uppercase">
            What values we follow
          </p>
          <h2 className="text-primary-dark text-4xl lg:text-5xl uppercase tracking-tight font-heading font-semibold">
            Principle Statement
          </h2>
          <p className="text-md lg:text-lg text-primary-dark font-body flex items-center gap-3">
