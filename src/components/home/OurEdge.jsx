    ...
    return (
        <section className='py-10 px-16 bg-page'>
            ...
            <div className='text-center space-y-4'>
                <p className='text-xl font-bold font-body text-accent uppercase'>HOW Are We Different</p>
                <h3 className='text-5xl font-semibold font-heading tracking-tight uppercase'>OUR Edge</h3>
            </div>
            {/* 3 main content */}
            <div className='grid grid-cols-3 gap-4 mt-10'>
                ...
                {Edges.map((item, index) => (
                    <div className='text-center place-items-center p-3 space-y-7' key={index}>
                        <div className='text-6xl text-primary'>{item.icon}</div>
                        <div className='space-y-2'><h3 className='text-3xl font-heading tracking-tight font-semibold uppercase text-primary-dark'>{item.title}</h3>
                            <p className='font-body text-xl text-primary-dark'>{item.para}</p></div>
                    </div>
                ))}
            </div>
        </section>
